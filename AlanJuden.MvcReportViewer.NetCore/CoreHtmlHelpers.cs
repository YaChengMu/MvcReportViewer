...
namespace AlanJuden.MvcReportViewer
{
    public static class CoreHtmlHelpers
    {
        ...
        public static async Task<string> ParametersToHtmlString(System.Collections.Generic.List<ReportParameterInfo> parameters, ReportViewerModel model)
        {
            ...
            if (parameters == null)
            {
                ...
                var definedParameters = await ReportServiceHelpers.GetReportParametersAsync(model, true);
